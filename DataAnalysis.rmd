...
ClimateTest1 <- lm(formula = rank ~ hours_of_sunlight_per_city + average_enrollment_from_2020_2018 + annual_green_power_usage_k_wh + wind + solar + Biomas + Various, data = FullClimateData)
#summary1
