...
cityStateObservations7.21 %>% count(city_location_of_institution, sort = TRUE)
cityStateObservations7.21 %>% count(college_state, sort = TRUE)
...
cityStateObservations4.21 %>% count(city_location_of_institution, sort = TRUE)
cityStateObservations4.21 %>% count(college_state, sort = TRUE)
...
cityStateObservations1.21 %>% count(city_location_of_institution, sort = TRUE)
cityStateObservations1.21 %>% count(college_state, sort = TRUE)
...
cityStateObservations10.20 %>% count(city_location_of_institution, sort = TRUE)
cityStateObservations10.20 %>% count(college_state, sort = TRUE)
...
cityStateObservations7.20 %>% count(city_location_of_institution, sort = TRUE)
cityStateObservations7.20 %>% count(college_state, sort = TRUE)
...
cityStateObservations4.20 %>% count(city_location_of_institution, sort = TRUE)
cityStateObservations4.20 %>% count(college_state, sort = TRUE)
...
cityStateObservations1.20 %>% count(city_location_of_institution, sort = TRUE)
cityStateObservations1.20 %>% count(college_state, sort = TRUE)
...
cityStateObservations7.19 %>% count(city_location_of_institution, sort = TRUE)
cityStateObservations7.19 %>% count(college_state, sort = TRUE)
...
cityStateObservations4.19 %>% count(city_location_of_institution, sort = TRUE)
cityStateObservations4.19 %>% count(college_state, sort = TRUE)
...
cityStateObservations2.19 %>% count(city_location_of_institution, sort = TRUE)
cityStateObservations2.19 %>% count(college_state, sort = TRUE)
...
cityStateObservations10.18 %>% count(city_location_of_institution, sort = TRUE)
cityStateObservations10.18 %>% count(college_state, sort = TRUE)
...
cityStateObservations7.18 %>% count(city_location_of_institution, sort = TRUE)
cityStateObservations7.18 %>% count(college_state, sort = TRUE)
...
cityStateObservations4.18 %>% count(city_location_of_institution, sort = TRUE)
cityStateObservations4.18 %>% count(college_state, sort = TRUE)
...
cityStateObservations1.18 %>% count(city_location_of_institution, sort = TRUE)
cityStateObservations1.18 %>% count(college_state, sort = TRUE)

```


```{r}
groupByDate <- group_by(FullclimateData, month_year_collected)
summarise_all(groupByDate, funs(mean))
...
ClimateTest1 <- lm(formula = rank ~ average_enrollment_from_2020_2018 + annual_green_power_usage_k_wh + gp_percent_total_energy_use + Various, data = FullClimateData)
#summary1
