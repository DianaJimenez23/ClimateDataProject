...
```{r}
gsub("-","",as.character(climateData$college_name)) %>%
gsub("the","The",as.character(climateData$college_name)) %>%
gsub("university", "University",as.character(climateData$college_name))
View(climateData)
```
